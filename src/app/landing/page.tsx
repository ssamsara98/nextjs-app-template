...
import team_4_470x470_png from '~/assets/images/team-4-470x470.png';
          ...
          <div className="container mx-auto px-4">
            ...
            <div className="flex flex-wrap items-center mt-32">
              <div className="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <Link href="/demo" className="font-bold text-slate-700 mt-8">
                  Check Notus NextJS!
                </Link>
              </div>
              ...
              <div className="w-full md:w-5/12 ml-auto mr-auto px-4">
                <div className="md:pr-12">
                  <div className="text-slate-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-slate-200">
                    ...
                    <Icon as={FaRocket} className="text-xl" />
                  </div>
            ...
            <div className="flex flex-wrap mt-12 justify-center">
              <div className="w-full lg:w-3/12 px-4 text-center">
                <div className="text-slate-800 p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center">
                  ...
                  <Icon as={FaMedal} className="text-xl" />
                </div>
              ...
              <div className="w-full lg:w-3/12 px-4 text-center">
                <div className="text-slate-800 p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center">
                  ...
                  <Icon as={FaPoll} className="text-xl" />
                </div>
              ...
              <div className="w-full lg:w-3/12 px-4 text-center">
                <div className="text-slate-800 p-3 w-12 h-12 shadow-lg rounded-full bg-white inline-flex items-center justify-center">
                  ...
                  <Icon as={FaLightbulb} className="text-xl" />
                </div>
