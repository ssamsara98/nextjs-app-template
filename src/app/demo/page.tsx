...
import patternNextjsPng from '~/assets/images/pattern_nextjs.png';
import component_btn_pink_png from '~/assets/images/component-btn-pink.png';
import component_btn_png from '~/assets/images/component-btn.png';
import component_info_2_png from '~/assets/images/component-info-2.png';
import component_info_card_png from '~/assets/images/component-info-card.png';
import component_menu_png from '~/assets/images/component-menu.png';
import component_profile_card_png from '~/assets/images/component-profile-card.png';
import documentationPng from '~/assets/images/documentation.png';
import loginJpg from '~/assets/images/login.jpg';
import profileJpg from '~/assets/images/profile.jpg';
import landingJpg from '~/assets/images/landing.jpg';

import { Navbar as IndexNavbar } from '~/components/navbars/index-navbar';
          ...
          <div className="flex flex-wrap items-center">
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              <div className="text-slate-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                ...
                <Icon as={FaSitemap} className="text-xl" />
              </div>
          ...
          <div className="flex flex-wrap items-center pt-32">
            ...
            <div className="w-full md:w-4/12 px-12 md:px-4 ml-auto mr-auto mt-48">
              <div className="text-slate-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                ...
                <Icon as={FaDraftingCompass} className="text-xl" />
              </div>
              ...
              >
                View all
                {/* <i className="fa fa-angle-double-right ml-1 leading-relaxed"></i> */}
                <Icon as={FaAngleDoubleRight} className="ml-1 leading-relaxed" />
              </Link>
            </div>
          </div>
        </div>
            ...
            <div className="w-full md:w-5/12 ml-auto px-12 md:px-4">
              <div className="md:pr-12">
                <div className="text-slate-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                  ...
                  <Icon as={FaFileAlt} className="text-xl" />
                </div>
                ...
                <p className="mt-4 text-lg leading-relaxed text-slate-500">
                  ...
                  the colors and also the programming language. You can change the text and images and you&apos;re good
                  to go.
                </p>
          ...
          <div className="flex flex-wrap justify-center">
            <div className="w-full md:w-5/12 px-12 md:px-4 ml-auto mr-auto md:mt-64">
              <div className="text-slate-500 p-3 text-center inline-flex items-center justify-center w-16 h-16 mb-6 shadow-lg rounded-full bg-white">
                ...
                <Icon as={FaCodeBranch} className="text-xl" />
              </div>
              ...
              <p className="text-lg font-light leading-relaxed mt-4 mb-4 text-slate-400">
                Since{' '}
                <Link href="https://tailwindcss.com/?ref=creative" className="text-slate-300" target="_blank">
                  Tailwind CSS
                </Link>{' '}
            ...
            <div className="w-full md:w-4/12 px-4 mr-auto ml-auto mt-32 relative">
              ...
              <Icon
                as={FaGithub}
                className="text-slate-700 absolute text-55 -top-150-px -right-100 left-auto opacity-80"
              />
            </div>
          </div>
        </div>
            ...
            <div className="w-full text-center lg:w-8/12">
              ...
              <div className="sm:block flex flex-col mt-10">
                ...
                >
                  ...
                  <Icon as={FaGithub} className="text-lg mr-1" />
