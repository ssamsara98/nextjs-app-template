...
import img_1_1000x600_jpg from '~/assets/images/img-1-1000x600.jpg';
    ...
    <div>
      <div
        ...
        style={{
          ...
          backgroundImage: `url('${img_1_1000x600_jpg.src}')`,
        }}
      ></div>
      ...
      <div className="my-32 mx-auto max-w-sm text-center relative z-50 top-0">
        <div className="block mb-4">
          ...
          <Icon as={FaCircleNotch} className="animate-spin text-white mx-auto text-6xl" />
        </div>
