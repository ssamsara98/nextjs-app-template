            ...
            <ul className="flex flex-col lg:flex-row list-none mr-auto">
              <li className="flex items-center">
                ...
                >
                  ...
                  <Icon as={FaRegFileAlt} className="text-slate-400 text-lg leading-lg mr-2" />
                  Docs
                </Link>
              </li>
            </ul>
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                ...
                >
                  ...
                  <Icon as={FaFacebook} className="text-slate-400 text-lg leading-lg" />
              ...
              <li className="flex items-center">
                ...
                >
                  ...
                  <Icon as={FaTwitter} className="text-slate-400 text-lg leading-lg" />
              ...
              <li className="flex items-center">
                ...
                >
                  ...
                  <Icon as={FaGithub} className="text-slate-400 text-lg leading-lg" />
