...
import { FaArrowAltCircleDown, FaBars, FaFacebook, FaGithub, FaRegFileAlt, FaTwitter } from 'react-icons/fa';
        ...
        <div className="container px-4 mx-auto flex flex-wrap items-center justify-between">
          <div className="w-full relative flex justify-between lg:w-auto lg:static lg:block lg:justify-start">
            ...
            {/* <i className="text-white fas fa-bars"></i>
              <Icon as={FaBars} className="text-white" />
            </IconButton> */}
          </div>
          <div
            className={
            ...
            <ul className="flex flex-col lg:flex-row list-none mr-auto">
              <li className="flex items-center">
                ...
                >
                  ...
                  <Icon as={FaRegFileAlt} className="lg:text-slate-200 text-slate-400 text-lg leading-lg mr-2" /> Docs
                </a>
              </li>
            </ul>
            <ul className="flex flex-col lg:flex-row list-none lg:ml-auto">
              ...
              <li className="flex items-center">
                ...
                >
                  ...
                  <Icon as={FaFacebook} className="lg:text-slate-200 text-slate-400 text-lg leading-lg" />
              ...
              <li className="flex items-center">
                ...
                >
                  ...
                  <Icon as={FaTwitter} className="lg:text-slate-200 text-slate-400 text-lg leading-lg" />
              ...
              <li className="flex items-center">
                ...
                >
                  ...
                  <Icon as={FaGithub} className="lg:text-slate-200 text-slate-400 text-lg leading-lg" />
              ...
              <li className="flex items-center">
                ...
                >
                  ...
                  <Icon as={FaArrowAltCircleDown} /> Download
                </button>
              </li>
            </ul>
          </div>
