      ...
      <div className="relative flex flex-col min-w-0 break-words bg-white w-full mb-6 shadow-xl rounded-lg mt-16">
        <div className="px-6">
          ...
          <div className="text-center mt-12">
            <h3 className="text-xl font-semibold leading-normal mb-2 text-slate-700">Jenna Stones</h3>
            <div className="text-sm leading-normal mt-0 mb-2 text-slate-400 font-bold uppercase">
              ...
              <Icon as={FaMapMarkerAlt} className="mr-2 text-lg text-slate-400" />
              Los Angeles, California
            </div>
            <div className="mb-2 text-slate-600 mt-10">
              {/* <i className="fas fa-briefcase mr-2 text-lg text-slate-400"></i> */}
              <Icon as={FaBriefcase} className="mr-2 text-lg text-slate-400" />
              Solution Manager - Creative Tim Officer
            </div>
            <div className="mb-2 text-slate-600">
              {/* <i className="fas fa-university mr-2 text-lg text-slate-400"></i> */}
              <Icon as={FaUniversity} className="mr-2 text-lg text-slate-400" />
